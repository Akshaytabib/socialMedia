...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        followers = view.findViewById(R.id.followerno);
        following = view.findViewById(R.id.followingno);
        posts = view.findViewById(R.id.postno);
        fullname = view.findViewById(R.id.profile_namess);
        bio = view.findViewById(R.id.bio);
        username = view.findViewById(R.id.usernamesprofile);
        myPictures = view.findViewById(R.id.my_pictures);
        savedPictures = view.findViewById(R.id.saved_pictures);
        editProfile = view.findViewById(R.id.edit_profile);

        recyclerView = view.findViewById(R.id.show_allpost);
        ...
        recyclerViewSaves = view.findViewById(R.id.save_allpost);
